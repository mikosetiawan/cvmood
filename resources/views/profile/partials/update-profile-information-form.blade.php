    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div x-data="{photoName: null, photoPreview: null}">
            ...
            <div class="mt-2" x-show="! photoPreview">
                @if($user->avatar)
                    <img src="{{ asset('storage/' . $user->avatar) }}" alt="{{ $user->name }}" class="rounded-full h-20 w-20 object-cover">
                @else
                    <div class="rounded-full h-20 w-20 bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
            ...
            <x-secondary-button class="mt-2 me-2" type="button" x-on:click.prevent="$refs.avatar.click()">
